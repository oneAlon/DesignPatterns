...
/*
 ...
 UIImage
 (UIImage的子类)bmpImage                                               jpgImage    gifImage    pngImage
 (bmpImage的子类)bmpWindowsImage bmpLinuxImage bmpUnixImage     ......
 ...
 适用场景:
    如果一个系统存在两个独立变化的维度, 可以使用这个模式将两个维度分离出来, 是两者独立扩展, 让系统符合单一职责原则.
